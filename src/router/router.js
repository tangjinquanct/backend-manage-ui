...
export const otherRouter = {
    ...
    component: Main,
    children: [
        { path: 'config-manage/data-config/add-data-config', title: '添加数据配置', name: 'add-data-config', component: resolve => { require(['@/views/config-manage/data-config/add-data-config.vue'], resolve); } },
        { path: 'config-manage/data-config/edit-data-config', title: '编辑数据配置', name: 'edit-data-config', component: resolve => { require(['@/views/config-manage/data-config/edit-data-config.vue'], resolve); } },
        { path: 'config-manage/topology-config/add-topology-config', title: '添加topology配置', name: 'add-topology-config', component: resolve => { require(['@/views/config-manage/topology-config/add-topology-config.vue'], resolve); } },
        { path: 'config-manage/topology-config/edit-topology-config', title: '编辑topology配置', name: 'edit-topology-config', component: resolve => { require(['@/views/config-manage/topology-config/edit-topology-config.vue'], resolve); } },
...
export const appRouter = [
    {
        ...
        component: Main,
        children: [
            { path: 'data-config', title: '数据配置', name: 'data-config', icon: 'android-settings', component: resolve => { require(['@/views/config-manage/data-config/data-config.vue'], resolve); } },
            { path: 'topology-config', title: 'topology配置', name: 'topology-config', icon: 'android-settings', component: resolve => { require(['@/views/config-manage/topology-config/topology-config.vue'], resolve); } }
        ]
    },
    {
        path: '/access',
