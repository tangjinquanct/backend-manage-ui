    ...
    <Card>
        ...
        <Form ref="rowData" :model="rowData" :label-width="100" :rules="ruleValidate">
            <FormItem label="dataName" prop="dataName">
                <Input v-model="rowData.dataName" placeholder="请输入" value="rowData.dataName"></Input>
            </FormItem>
            ...
            <Card dis-hover>
                ...
                <a slot="extra">
                    <Button type="primary" @click="">可使用模板</Button>
                </a>
            ...
            <Card dis-hover style="margin-bottom: 12px">
                ...
                <FormItem label="storeConfig" prop="storeConfig">
    ...
    export default {
        ...
        methods: {
            ...
            doAddData: function () {
                var This = this;
                if (This.checkData()) {
                    This.$apiAxios.post('/dataConfig/addDataConfig', This.rowData, function (result) {
                        if (result.code === 200) {
